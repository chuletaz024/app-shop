            ...
            <form class="form" method="POST" action="{{ route('register') }}">
                ...
                <div class="content"> 
                    ...
                    <div class="input-group">
                        ...
                        <input placeholder="Contrasenia" id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required/>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input placeholder="Confirmar contrasenia" id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password_confirmation" required/>
                    </div>
