...
<head>
    ...
    <title>@yield('title','INTERMAQ')</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navigation-example">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="{{ url('/asesoria') }}" class="nav-item">Asesoria</a>
                    </li>
                    <li>
                        <a href="{{ url('/mantenimiento') }}" class="nav-item">Mantenimiento</a>
                    </li>
                    @guest
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div>
                            <ul class="dropdown-menu" role="menu">
                                ...
                                @if (auth()->user()->admin)
                                <li>
                                    <a href="{{ url('/admin/products') }}">Gestionar productos de venta</a>
                                </li>
                                <li>
